...
from travel_planner.subagents.hotel_agent import hotel_agent, hotel_agent_openai, hotel_agent_ollama
...
coordinator_agent = Agent(
    ...
    instruction=f"""
                 ...
                 """,
    sub_agents=[flight_agent, hotel_agent_ollama]
)


##### direct test with ollama model:
# https://www.youtube.com/watch?v=QN14IFM9s04

# AGENT_MODEL = "ollama/gemma3:12b-it-qat" # works
#AGENT_MODEL = "ollama/mistral-small3.1" # works
AGENT_MODEL = "ollama_chat/gemma3:12b-it-qat" # works
root_agent = Agent(
    name="Pirate_agent",
    model=LiteLlm(model=AGENT_MODEL),
    description="Acts like a pirate",
    instruction="You are a pirate called Jolly Roger, you act like a pirate and response in pirate speak"
)

root_agent = coordinator_agent # to review
hello = True
